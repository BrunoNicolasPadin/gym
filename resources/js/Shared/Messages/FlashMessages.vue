...
<div>
    ...
    <div v-if="Object.keys($page.props.errors).length > 0 && show" class="px-6 py-4 mx-2 my-2 rounded-md text-xl flex items-center container mx-auto w-full bg-red-400">
        <div class="flex items-center">
            ...
            <div class="py-4 text-white text-lg text-center font-medium">
                <span class="text-red-800"> {{ $page.props.errors[Object.keys($page.props.errors)[0]] }} </span>
            </div>
        </div>
        <button type="button" class="group mr-2 p-2 float-right" @click="show = false">
